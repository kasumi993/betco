 ...
 * @var $css_animation - css animation
 * Shortcode class
...
if ( $image_background_position == 'top' ){
	$css_classes[] = 'vc_row-background-top';
}

if ( $image_background_position == 'bottom' ) {
	$css_classes[] = 'vc_row-background-bottom';
}

if ( !empty($overflow_visible) ){
	$css_classes[] = 'vc_row-overflow-visible';
}
